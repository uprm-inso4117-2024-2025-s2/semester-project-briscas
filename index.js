...
const app = express();
const server = http.createServer(app); // ✅ Bind HTTP server

// Initialize WebSocket server
initializeSocketServer(server); // ✅ Attach WebSocket logic
...
// Start server
server.listen(3000, () => {
  console.log("🚀 Server with WebSocket started on http://localhost:3000");
});
// const GameManager = require("./models/GameManager");
// const Card = require("./models/Card.js");
